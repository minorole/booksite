  ...
  return (
    <>
      ...
      <div className={cn(
        ...
        <main className="relative flex-1 flex flex-col items-center justify-center px-4 pt-0 pb-4">
          {/* subtle hero glow */}
          ...
          <div className="w-full max-w-4xl mx-auto text-center space-y-4 -mt-4 md:-mt-6">
            <LotusModel />
