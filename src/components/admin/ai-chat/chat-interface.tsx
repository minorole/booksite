      ...
      <div className="flex items-center justify-between p-4">
        <div className="text-muted-foreground flex items-center gap-1 text-xs">
          {requestId && (
            <>
              <span>
                <Bilingual as="span" cnText="请求" enText="Request" />: {requestId.slice(0, 8)}
              </span>
              <Button
                variant="ghost"
                size="icon"
...
export function ChatInterface() {
  return (
    <div className="theme-catppuccin text-foreground mx-auto flex h-[calc(100vh-12rem)] w-full max-w-6xl flex-col">
      <ChatBody />
    </div>
  );
}
