...
- Env configured in .env.local for DATABASE*URL, DIRECT_URL, OPENAI_API_KEY (admin), NEXT_PUBLIC*\* Supabase, NEXT_PUBLIC_SUPER_ADMIN_EMAIL, CLOUDINARY_URL. OPENAI_API_KEY_USER optional for this validation.
